...
TYPES = fixture_text('wifi/provisioning/wps/test_wifi_wps_ap_session/types.inc')

CASES = fixture_text('wifi/provisioning/wps/test_wifi_wps_ap_session/cases.inc')

BOUNDARIES = fixture_text('wifi/provisioning/wps/test_wifi_wps_ap_session/boundaries.inc')
