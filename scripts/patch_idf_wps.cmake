...
set(_esp32qjs_wps_script "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_native.py")
...
set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${_esp32qjs_wps_script}"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_errors.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_registrar.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_registrar_timers.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_ap_result.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_ap_close.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_ap_init_cleanup.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_ap_input.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_ap_commands.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_eap_control.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_eap_lifecycle.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_eap_secrets.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_eapol.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_eapol_retire.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_wps_peer_delays.py"
...
endforeach()
execute_process(
    COMMAND "${_esp32qjs_wps_python}" "${_esp32qjs_wps_script}"
