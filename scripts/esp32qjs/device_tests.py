...
JS_TEST_MODULES = (
    ...
    JsTestModule(
        ...
        (
            ...
            JsTestCase(
                "modules/wifi/driver-lifecycle-hardware.js",
            ...
            JsTestCase(
                "modules/wifi/monitor-configure-hardware.js",
                required_capabilities=("wireless-hardware",),
            ...
            JsTestCase(
                "modules/wifi/monitor-retained-hardware.js",
                required_capabilities=("wireless-hardware",),
            ...
            JsTestCase(
                "modules/wifi/monitor-batch-hardware.js",
                required_capabilities=("wireless-hardware", "network"),
                timeout_seconds=60.0,
                reset_before=True,
                reset_after=True,
                record_details=True,
            ...
            JsTestCase(
                "modules/wifi/raw-tx-hardware.js",
                required_capabilities=("wireless-hardware",),
                timeout_seconds=45.0,
                reset_before=True,
                reset_after=True,
            ...
            JsTestCase(
                "modules/wifi/ap-lifecycle-hardware.js",
                required_capabilities=("wireless-hardware", "network"),
                timeout_seconds=60.0,
                reset_before=True,
                reset_after=True,
            ...
            JsTestCase(
                "modules/wifi/raw-tx-rate-hardware.js",
                required_capabilities=("wireless-hardware",),
                timeout_seconds=45.0,
                reset_before=True,
                reset_after=True,
            ...
            JsTestCase(
                "modules/wifi/late-station-netif-hardware.js",
                required_capabilities=("wireless-hardware", "network"),
                timeout_seconds=30.0,
                reset_before=True,
                reset_after=True,
            ...
            JsTestCase(
                "modules/wifi/raw-tx-lr-hardware.js",
                required_capabilities=("wireless-hardware",),
                timeout_seconds=45.0,
                reset_before=True,
                reset_after=True,
    ...
    JsTestModule(
        ...
        (
            ...
            JsTestCase(
                "modules/wifi_csi/packet-hardware.js",
                required_capabilities=("csi-hardware",),
                timeout_seconds=60.0,
                reset_before=True,
                reset_after=True,
