...
set(_esp32qjs_vendor_script "${CMAKE_CURRENT_LIST_DIR}/patch_idf_vendor_ie_context.py")
...
set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS
    ...
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_offchan_frame.py"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_nan_sd.py")
...
execute_process(
    COMMAND "${_esp32qjs_vendor_python}" "${_esp32qjs_vendor_script}"
