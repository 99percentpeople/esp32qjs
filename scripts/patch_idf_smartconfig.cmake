...
set(_sc_script "${CMAKE_CURRENT_LIST_DIR}/patch_idf_smartconfig.py")
...
set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${_sc_script}"
    "${CMAKE_CURRENT_LIST_DIR}/patch_idf_smartconfig_stack.py"
...
execute_process(COMMAND "${_sc_python}" "${_sc_script}"
