...
set(_pair_script "${CMAKE_CURRENT_LIST_DIR}/patch_idf_nan_pairing.py")
...
endforeach()
execute_process(COMMAND "${_pair_python}" "${_pair_script}" --components "${_pair_components}" --output-dir "${_pair_output}"
