...
# FTM changes another function in the same member before this adapter runs.
FTM_OBJECTS = {
    'esp32c3': 'e55528e3087c15a78f68e242206b66cb85fb3973ac6dc21b4dcef2937fad1fe9',
    'esp32s3': '367b4d2891d46e55df7d54b84d0d79b10b9737f81074d1359c700542fa0f1f60',
    'esp32c5': 'dab78e77911afd49d214ae946d043df97cf63fa74c18b741eb9be11c54a03664'
}
...
def patch_object(source: bytes, target: str) -> bytes:
    if target not in OBJECTS or hashlib.sha256(source).hexdigest() not in (OBJECTS[target], FTM_OBJECTS[target]):
