...
{
    esp32qjs_repl_compute_layout(buf,
                                 len,
                                 cursor,
                                 REPL_DISPLAY_COLUMNS,
                                 prompt_len_for_line(0),
                                 prompt_len_for_line(1),
...
{
    return esp32qjs_repl_needs_multiline_continuation(buf, len);
}
