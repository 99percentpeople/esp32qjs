...
set(_esp32qjs_netif_patch_script "${CMAKE_SOURCE_DIR}/scripts/sdk_patches/netif/timer.py")
...
execute_process(
    COMMAND "${_esp32qjs_netif_python}" "${CMAKE_SOURCE_DIR}/scripts/sdk_patch.py" netif_timer
