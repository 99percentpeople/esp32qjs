...
set(_qjs_identity_script "${CMAKE_SOURCE_DIR}/scripts/sdk_patches/wifi/raw_tx_identity.py")
...
execute_process(COMMAND "${_qjs_identity_python}" "${CMAKE_SOURCE_DIR}/scripts/sdk_patch.py" raw_tx_identity
