...
set(_ap_prestart_script "${CMAKE_SOURCE_DIR}/scripts/sdk_patches/wifi/ap_prestart.py")
set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${_ap_prestart_source}" "${_ap_prestart_script}")
execute_process(COMMAND "${_ap_prestart_python}" "${CMAKE_SOURCE_DIR}/scripts/sdk_patch.py" ap_prestart
