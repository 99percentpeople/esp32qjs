...
set(_esp32qjs_dpp_script "${CMAKE_SOURCE_DIR}/scripts/sdk_patches/wpa/dpp.py")
...
endforeach()
execute_process(COMMAND "${_esp32qjs_dpp_python}" "${CMAKE_SOURCE_DIR}/scripts/sdk_patch.py" dpp
