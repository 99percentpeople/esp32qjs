...
set(_qjs_rate_script "${CMAKE_SOURCE_DIR}/scripts/sdk_patches/wifi/tx_rate.py")
...
execute_process(COMMAND "${_qjs_rate_python}" "${CMAKE_SOURCE_DIR}/scripts/sdk_patch.py" tx_rate
