...
set(_esp32qjs_eap_script "${CMAKE_SOURCE_DIR}/scripts/sdk_patches/wpa/eap/control.py")
...
endforeach()
execute_process(
    COMMAND "${_esp32qjs_eap_python}" "${CMAKE_SOURCE_DIR}/scripts/sdk_patch.py" eap_control
