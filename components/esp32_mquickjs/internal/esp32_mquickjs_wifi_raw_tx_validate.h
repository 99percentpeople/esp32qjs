...
/* Allocation/SDK/JS-free preflight for this build's frame format allowlist. Input must be
 ...
 * MAC layout, not arbitrary management/action bodies. Association-dependent
 * sequence, DS and flag constraints are evaluated only by the SDK at submission. */
