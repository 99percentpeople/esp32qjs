...
static const uint32_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  /* sorted atom table (offset=809) */
  JS_VALUE_ARRAY_HEADER(241),
  ...
  /* global object properties (offset=2342) */
